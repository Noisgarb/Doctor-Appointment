...
class _CalendarState extends State<Calendar> {
  ...
  void _onDaySelected(DateTime day, DateTime focusedDay) {
    setState(() {
      ...
      workShift = AddWorkOffShift(selDate: selDate!);
    });
  }
  ...
  void initState() {
    ...
    lastDate = DateTime(currentYear!, currentMonth!, currentDay! + 6);
    addToEvent();
...
class AddWorkOffShift extends StatefulWidget {
  // ignore: non_constant_identifier_names
  String selDate;
  // ignore: non_constant_identifier_names
  AddWorkOffShift({super.key, required this.selDate});

  @override
  State<AddWorkOffShift> createState() => _AddWorkOffShiftState();
}

class _AddWorkOffShiftState extends State<AddWorkOffShift> {
  @override
  Widget build(BuildContext context) {
